...
global {
    ...
    float prey_energy_grazing <- 0.01;
    float prey_energy_wandering <- 0.02;
...
//    	write options;
		list<predator> others <- (predator at_distance 6); // list of "visible" predators
		// TODO
